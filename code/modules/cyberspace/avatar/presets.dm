/*
	//!!! Do not uncomment, if you don't want to slow world's initialization speed to zero !!!
ADD_CYBERSPACE_AVATAR(/obj/machinery)
	//If you finishing it after me add it only on network machines and etc
*/
...
ADD_CYBERSPACE_AVATAR_CUSTOM_COLOR(/mob/living/carbon/human, CYBERSPACE_SHADOW_COLOR)
